...
{
    return 360/Double(sides)
}
    
    
    
func drawPolygon(sides: Int, sideLength: Int, rotation: Double)
{
    for _ in 1...sides
    {
        move(sideLength)
...
var rotation: Double = calculateRotationForPolygon(10)
drawPolygon(10, sideLength: 50, rotation: rotation )
